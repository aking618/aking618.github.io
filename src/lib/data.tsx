...
export const EXPERIENCES: ExperienceDetails[] = [
  {
    ...
    company: 'Phillips',
    position: 'Founding iOS Developer',
    startDate: new Date(2024, 5),
    currentlyWorkHere: true,
    summary: [
      'Spearheaded development of a new auction engagement app, building the codebase from the ground up.',
      'Defined foundational systems and patterns for scalable feature development and team growth.',
      'Implemented SwiftUI with TCA for a robust application.',
      'Created developer tooling for streamlined releases, versioning, and string localization.',
      'Worked in lockstep with design and product teams to iterate on a polished user experience.',
    ],
